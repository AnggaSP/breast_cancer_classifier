...
SINGLE_OUTPUT_PATH='output_single'
...
python3 src/cropping/crop_single.py \
    --mammogram-path $1 \
    --view $2 \
    --cropped-mammogram-path ${SINGLE_OUTPUT_PATH}/cropped.png \
    --metadata-path ${SINGLE_OUTPUT_PATH}/cropped_metadata.pkl
...
python3 src/heatmaps/run_producer_single.py \
    ...
    --heatmap-path-malignant ${SINGLE_OUTPUT_PATH}/malignant_heatmap.hdf5 \
    --heatmap-path-benign ${SINGLE_OUTPUT_PATH}/benign_heatmap.hdf5\
