...
INITIAL_EXAM_LIST_PATH='data/exam_list.pkl'
PATCH_MODEL_PATH='models/patch_model.p'
IMAGE_MODEL_PATH='models/image_model.p'
IMAGEHEATMAPS_MODEL_PATH='models/imageheatmaps_model.p'

CROPPED_IMAGE_PATH='output/cropped_images'
CROPPED_EXAM_LIST_PATH='output/cropped_images/cropped_exam_list.pkl'
EXAM_LIST_PATH='output/data.pkl'
HEATMAPS_PATH='output/heatmaps'
IMAGE_PREDICTIONS_PATH='output/image_predictions.csv'
IMAGEHEATMAPS_PREDICTIONS_PATH='output/imageheatmaps_predictions.csv'
